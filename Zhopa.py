...
def startCommand(bot, update):
    bot.send_message(chat_id=update.message.chat_id,
                     text='Привіт, це бот для зручного\n '
                          'перегляду розкладу\n '
                          'ліцейних класів\n'
                          '(8 філ; 8 пм; 1 філ; 1 пр;\n'
                          ' 1 мат; 2 філ; 2 мат; 3 філ; 3 пм)\n'
                          'на пн, вт, ср, чт, пт\n'
...
def helpCommand(bot, update):
    bot.send_message(chat_id=update.message.chat_id,
                     text ='Доступні команди :\n'
                           '/Rozklad_na_tyzden - показує розклад на тиждень \n вибраного вами класу...\n'
                           'Щоб отримати розклад \n'
                           'на один день введи запит\n'
                           'за зразком : 2 мат пн ')
